...
export function Contact() {
  ...
  const field =
    "w-full rounded-lg border border-border glass-surface px-4 py-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary";
