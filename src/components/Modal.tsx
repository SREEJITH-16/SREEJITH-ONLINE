  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={-1}
        className={`modal-pop glass-modal relative max-h-[88vh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-border p-0 shadow-2xl outline-none ${className}`}
      >
        <button
          type="button"
          onClick={onClose}
