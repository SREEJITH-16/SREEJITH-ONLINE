        ...
        <div ref={trackRef} className="relative hidden items-center gap-1 lg:flex">
          ...
          {navLinks.map((l) => (
            <a
              ...
              className={`relative z-10 rounded-full px-4 py-2 text-xs transition-colors duration-300 ${
      ...
      <style>{`
        .liquid-glass {
          background: linear-gradient(
            ...
            color-mix(in oklab, var(--accent-2) 10%, transparent) 100%
          );
          ...
          box-shadow:
            ...
            inset 0 -1px 6px color-mix(in oklab, var(--primary) 8%, transparent),
            0 6px 18px -8px color-mix(in oklab, var(--primary) 32%, transparent);
          transition:
