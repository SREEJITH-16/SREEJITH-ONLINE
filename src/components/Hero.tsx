...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative flex min-h-[100svh] flex-col justify-center overflow-hidden pb-16 pt-28 sm:pb-24 sm:pt-36"
    >
      <div className="container-edit grid items-start gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
        <div>
          ...
          <div className="hero-in" style={{ animationDelay: "120ms" }}>
            <h1 className="mt-6 text-[12vw] leading-[1.02] tracking-tight sm:text-6xl md:text-[3.4rem] lg:text-[3.9rem]">
              {profile.tagline}
            </h1>
          </div>
        ...
        <div className="relative mx-auto w-full max-w-[460px] lg:mx-0">
          <div
            aria-hidden="true"
            className="orbit-ring pointer-events-none absolute -inset-10 -z-10 hidden sm:block"
          />
          ...
          <style>{`
            .portrait-glow {
              box-shadow: 0 0 60px -12px color-mix(in oklab, var(--primary) 35%, transparent);
            }
            .orbit-ring {
            ...
            .orbit-ring::after {
              ...
              box-shadow: 0 0 12px 2px color-mix(in oklab, var(--primary) 70%, transparent);
            }
